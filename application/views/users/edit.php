      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            ...
            <form role="form" action="<?php base_url('users') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" id="birthday" name="birthday" placeholder="Birthday" value="<?php echo $user_data['birthday'] ?>" autocomplete="off">
                </div>
