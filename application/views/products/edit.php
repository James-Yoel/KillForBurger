          ...
          <form role="form" action="" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="stock" name="stock" placeholder="Enter stock product" autocomplete="off" value="<?php echo !empty($this->input->post('stock')) ?:$product_data['stock'] ?>" />
                </div>
